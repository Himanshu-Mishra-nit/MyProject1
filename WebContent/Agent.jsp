...
%>
 <!-- Page Preloder -->
        ...
        <div class="language-bar">
            <div class="language-option">
                ...
                <div class="flag-dropdown">
                    <ul>
                        <li><a href="RaiputControl">Raipur</a></li>
  ...
  <a href="RegisterAgent.jsp">Click here For Register as Agent</a>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="property-pic">
                                        <img width='500' height='250' src=./DisplayAgentPhotoServlet?id=<%=id%>>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="property-text">
                                        <div class="s-text">Our Agents</div>
                                        <h5 class="r-title"><%= rs.getString("name") %></h5>
                                        <div class="room-price">
                                           
                                            <h5><%=rs.getString("profession") %></h5>
                                        </div>
                                        <div class="properties-location"><i class="fa fa-envelope"></i><%=rs.getString("email") %></div>
                                        <p> <i class="fa fa-phone"></i><%=rs.getString("num")%></p>
                                        <ul class="room-features">
                                            <li>
                                               <a href="<%=rs.getString("fb") %>"> <i class="fa fa-facebook-square"></i></a>
                                                <p><%=rs.getString("name") %></p>
                                            </li>
                                            <li>
                                                 <a href="<%=rs.getString("twitter") %>"> <i class="fa fa-twitter"></i></a>
                                                <p>@<%=rs.getString("name") %></p>
                                            </li>
                                          
                                            <li>
                                                 <a href="<%=rs.getString("insta") %>"> <i class="fa fa-camera-retro"></i></a>
                                                <p>@<%=rs.getString("name") %></p>
                                            </li>
                                        </ul>
                                    </div>
