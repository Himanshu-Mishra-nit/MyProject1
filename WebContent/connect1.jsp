...
try {
    ...
    String   ts4 =  ft4.getString();
    int t4=Integer.parseInt(ts4);
    
    FileItem ft5 = (FileItem) items.get(4);
    String   t5 =  ft5.getString();
    
    FileItem ft6 = (FileItem) items.get(5);
    String   ts6 =  ft6.getString();
    int t6=Integer.parseInt(ts6);
    
    FileItem ft7 = (FileItem) items.get(6);
    String   ts7 =  ft7.getString();
    int t7=Integer.parseInt(ts7);
    String t8="Book";
	int lastid=0;
    // get uploaded file
    ...
    PreparedStatement ps=con.prepareStatement("select ID from prj_submit_property");
    ...
    ps = con.prepareStatement("insert into prj_submit_property(ID,RoomType,Enviroment,LocalArea,Beds,Vhicle,Price,Area,Book,Image)values(?,?,?,?,?,?,?,?,?,?)");
